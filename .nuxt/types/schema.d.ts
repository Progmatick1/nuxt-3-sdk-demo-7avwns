...
declare module 'nuxt/schema' {
  interface NuxtConfig {
    ...
    modules?: (NuxtModule | string | [NuxtModule | string, Record<string, any>] | ["@storyblok/nuxt", NuxtConfig["storyblok"]] | ["nuxt-config-schema", NuxtConfig["nuxt-config-schema"]] | ["@nuxt/telemetry", NuxtConfig["telemetry"]])[],
  }
